...
I will go through the entire setup process for this lab and at the end I will create event logs to simulate attacks and search for said attacks through splunk queries. 

I set up the Ubuntu VM first by 
